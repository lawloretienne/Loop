...
In order to run this project, you must <a href="https://developer.vimeo.com/apps/new">Register Your App</a> to get proper credentials such as client_id, client_secret ...  Then you can store these credentials into `/res/values/defaults.xml` . 
